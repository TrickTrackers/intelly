...
var edit_ui1 = "";
function import1(xml, filename)
{
    var ui = this.edit_ui1.editor;
    ...
    try {
        ...
        ui.graph.setSelectionCells(ui.graph.importCells(children));
...
Actions.prototype.init = function()
{
	...
	this.addAction('save', function() { ui.saveFile(true,'save'); }, null, null, 'Ctrl+S').isEnabled = isGraphEnabled;
	this.addAction('saveAs...', function() { ui.saveFile(true,'saveas'); }, null, null, 'Ctrl+Shift+S').isEnabled = isGraphEnabled;
